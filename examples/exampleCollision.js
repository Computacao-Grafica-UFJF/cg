...
import { initRenderer, SecondaryBox, initDefaultBasicLight, createGroundPlane, onWindowResize, getMaxSize } from "../libs/util/util.js";
...
function updateAsset() {
    if (asset.loaded) {
        ...
        if (vec.z > 1.48) lerpConfig.destination = new THREE.Vector3(0.0, 0.0, -1.5);
        if (vec.z < -1.48) lerpConfig.destination = new THREE.Vector3(0.0, 0.0, 1.5);
