...
import { initRenderer, onWindowResize, initDefaultSpotlight, lightFollowingCamera } from "../libs/util/util.js";
...
function buildInterface() {
    var controls = new (function () {
        ...
        this.onSetRefraction = function () {
            if (this.refraction) cubeMapTexture.mapping = THREE.CubeRefractionMapping;
            else cubeMapTexture.mapping = THREE.CubeReflectionMapping;
