...
import { initRenderer, initDefaultBasicLight, createGroundPlane, SecondaryBox, onWindowResize, getMaxSize } from "../libs/util/util.js";
...
let assetManager = {
    ...
    checkLoaded: function () {
        if (!this.allLoaded) {
            if (this.dolphins && this.vase && this.flowers && this.f16 && this.soccerball && this.toucan && this.cow) {
                this.allLoaded = true;
                loadingMessage.hide();
            }
        }
    ...
    hideAll: function () {
        ...
        this.f16.visible = this.soccerball.visible = this.toucan.visible = this.cow.visible = false;
    },
};
...
function buildInterface() {
    ...
    // GUI interface
    var gui = new GUI();
    gui.add(controls, "type", ["dolphins", "vase", "flowers", "f16", "soccerball", "toucan", "cow"])
        .name("Change Object")
        .onChange(function (e) {
