...
function buildInterface() {
    const controls = new (function () {
        ...
        this.changeSpeed = () => {
            ...
            console.log(sphere1Config.alpha, sphere2Config.alpha);
        };
    ...
    gui.add(controls, "reset", true)
        .onChange(() => controls.changeSpeed())
        .name("Reset");
    gui.add(controls, "speed", 0.01, 0.25).name("Speed").onChange();
}
...
function render() {
    ...
    if (sphere1Config.move && sphere1.position.x > sphere1Config.destination.x) sphere1.translateX(-sphere1Config.alpha);
    if (sphere2Config.move && sphere2.position.x > sphere2Config.destination.x) sphere2.translateX(-sphere2Config.alpha);
